...
{ \centering
    \includegraphics[width=5.0cm]{images/clipboard-151031590.png} \par
}
...
{ \centering
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{|p{9cm}|c|}
            ...
            \hline
            Cruzado Flores, Abel & 202\\
            \hline
            Montes Yato, Fátima & 2024 \\
            \hline
        \end{tabular}
    \end{table}
    \vspace{0.5cm}
    \textbf{GRUPO:} \text{2} \par
    \textbf{DOCENTE A CARGO:} \text{Gamboa U., Jesus E.}
    \vfill
    {\large Lima, 2026} \par
}
