...
- **Comprender y aplicar** la regresión lineal múltiple mediante el desarrollo de un tutorial práctico en R.

### Objetivos específicos

- **Identificar** la variable respuesta y las variables explicativas del conjunto de datos.
- **Realizar** un análisis exploratorio univariado y bivariado.
- **Ajustar** un modelo de regresión lineal múltiple en R.
- **Verificar** los supuestos estadísticos del modelo.
- **Interpretar** los coeficientes de regresión.
- **Realizar** estimaciones y predicciones utilizando el modelo ajustado.
...
El conjunto de datos utilizado fue obtenido de la plataforma **Kaggle**, una fuente pública de datasets para análisis de datos y aprendizaje automático.
